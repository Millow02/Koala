  ...
  <main className="flex flex-col items-center w-full bg-gray-950 relative">
    ...
    <div className="relative flex flex-col items-center justify-center w-2/6 rounded-3xl bg-gray-950 h-3/5 mt-12 mx-60 px-16 py-8">
      <div className="flex flex-col items-center justify-center w-2/3">
        <h1 className="text-4xl font-bold mb-4 text-center">Get started with Koala</h1>
        <h3 className="text-lg mb-16 text-gray-300">Create a new account</h3>
        ...
        <h3 className="text-lg text-gray-400  mt-12">New to Koala?  <Link to="/sign-in" className="text-lg text-white underline">Sign in here</Link></h3>
      </div>
    </div>
  </main>
</div>
