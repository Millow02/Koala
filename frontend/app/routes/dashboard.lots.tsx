          ...
          <div className="flex flex-wrap gap-x-2 justify-center">
            {parkingLots.map((parkingLot) => (
              <Link
                ...
                onClick={() =>
                  console.log(`Navigating to parking lot ${parkingLot.id}`)
                }
              >
                <div
                  className="h-64 shadow-md rounded-xl  hover:border-white"
                    ...
                    <div className="flex">
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center">
                          <p className="text-med font-semibold mr-6 w-36">
                            Cameras Total:{" "}
                          </p>
                          <p className="">insert total</p>
                        </div>
                        <div className="flex items-center">
                          <p className="text-med font-semibold mr-6 w-36">
                            Membership Total:{" "}
