...
const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    <>
      <div
        className="bg-slate-600 shadow-lg rounded-lg flex h-40 mx-8 my-6 border-2 border-transparent hover:border-2 hover:border-white transition-transform duration-300"
      ...
      >
        ...
        >
          <h1 className="text-lg font-semibold text-center">
            {recordAttributes.date.split(" ")[1]}{" "}
            {recordAttributes.date.split(" ")[2]}{" "}
            {recordAttributes.date.split(" ")[3]}
          </h1>
          ...
          <div className="flex items-center justify-center text-xs text-gray-300 px-3">
            ...
            <p className="text-center line-clamp-1">{cameraDetails.position}</p>
          </div>
        </div>
        ...
        <div
          className="flex flex-col justify-between items-end py-4 pr-6"
          style={{ flex: "2" }}
        >
              ...
              <div className="md:w-3/5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-200">
                  <div>
                    ...
                    <p className="text-xl">
                      {recordAttributes.date} at {recordAttributes.time}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-sm">Location</p>
                    <p className="text-xl">
                      {cameraDetails.position}: {parkingLotDetails.name}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div
                      className={`inline-flex items-center px-3 py-1 mt-1 rounded-full text-sm font-medium ${
                        recordAttributes.status === "Attention-Required"
